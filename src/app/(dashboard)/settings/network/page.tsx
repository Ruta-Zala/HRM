...
/**
 * TEMP DISABLED: office Wi‑Fi / WFH network restriction settings.
 * Original page is commented below. Uncomment it (and remove this redirect) to re-enable.
 * Also restore Access Control in `src/lib/rbac.ts` and remove the `/settings/network` canAccessPath block.
 */
export default function NetworkAccessSettingsRedirectPage() {
